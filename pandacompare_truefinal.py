...
# === SETTINGS ===
password = "yourpassword"                 # 🔒 Your Excel password
file1_path = "file1.xlsx"                 # 📄 Original file
file2_path = "file2.xlsx"                 # 📄 Updated file
output_path = "highlighted_changes.xlsx"  # 📝 Output file
id_column = "ID"                          # 🔑 Unique ID column header
summary_column_name = "Added/Changed"     # 🗒️ Summary column header
...
# === STEP 6: Map headers to column numbers ===
header_row = 1
...
# === STEP 7: Map ID values to row numbers in Excel ===
id_to_row = {}
...
# === STEP 8: Define highlighting styles ===
...
for idx in diff_df.index:
    ...
    if excel_row and summary_lines:
        ...
        cell.value = "\n".join(summary_lines)
        cell.alignment = wrap_alignment  # Force line wrapping for multiline summaries

# === STEP 10: Save result ===
wb.save(output_path)
print(f"✅ Done! Output with highlights and change summaries saved to: {output_path}")
